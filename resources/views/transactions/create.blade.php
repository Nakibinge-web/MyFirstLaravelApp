        ...
        <form method="POST" action="{{ route('transactions.store') }}">
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    ...
                    <input type="number" step="0.01" name="amount" id="amount" value="{{ old('amount') }}" class="shadow border rounded w-full py-2 pl-12 pr-3 text-gray-700 @error('amount') border-red-500 @enderror" placeholder="0.00" required>
                </div>
                @error('amount')
                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-4 hidden-original-amount-field" 
            ...
            <div class="mb-6">
                ...
                <textarea name="description" id="description" rows="3" 
                          ...
                          placeholder="Enter transaction details..." required>{{ old('description') }}</textarea>
                @error('description')
                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                @enderror
            </div>
