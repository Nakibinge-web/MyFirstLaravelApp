        ...
        <form method="POST" action="{{ route('goals.update', $goal) }}">
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    ...
                    <input type="number" step="0.01" name="target_amount" id="target_amount" value="{{ old('target_amount', $goal->target_amount) }}" 
            ...
            <div class="mb-4">
                ...
                <input type="number" step="0.01" name="current_amount" id="current_amount" value="{{ old('current_amount', $goal->current_amount) }}" 
                       class="shadow border rounded w-full py-2 px-3 text-gray-700 @error('current_amount') border-red-500 @enderror" 
                       placeholder="0.00" required>
            ...
            <div class="mb-4">
                ...
                <input type="date" name="target_date" id="target_date" value="{{ old('target_date', $goal->target_date->format('Y-m-d')) }}" 
            ...
            <div class="mb-6">
                ...
                <textarea name="description" id="description" rows="3" 
                          ...
                          placeholder="Optional: Add details about your goal...">{{ old('description', $goal->description) }}</textarea>
                @error('description')
                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                @enderror
            </div>
